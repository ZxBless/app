...
export default function ConfigScreen() {
  ...
  return (
    <ScrollView style={styles.screen} contentContainerStyle={styles.content}>
      ...
      <View style={styles.infoCard}><Info size={20} color={colors.yellowDark} strokeWidth={2.5} /><Text style={styles.infoText}>Las tarifas se aplican a los nuevos registros. Los registros existentes conservan la tarifa con la que fueron creados.</Text></View>
      <View style={styles.rateCard}>
        <View style={styles.rateHeader}><View style={styles.rateIcon}><Pickaxe size={24} color={colors.black} strokeWidth={2.5} /></View><View><Text style={styles.rateTitle}>Excavación</Text><Text style={styles.rateSubtext}>Tarifa por hora</Text></View></View>
      ...
      <View style={styles.rateCard}>
        <View style={styles.rateHeader}><View style={styles.rateIcon}><Hammer size={24} color={colors.black} strokeWidth={2.5} /></View><View><Text style={styles.rateTitle}>Martillo Hidráulico</Text><Text style={styles.rateSubtext}>Tarifa por hora</Text></View></View>
      ...
      <View style={styles.rateCard}>
        <View style={styles.rateHeader}><View style={styles.rateIcon}><Target size={24} color={colors.black} strokeWidth={2.5} /></View><View><Text style={styles.rateTitle}>Objetivo semanal</Text><Text style={styles.rateSubtext}>Horas meta por semana</Text></View></View>
      ...
      <TouchableOpacity style={[styles.saveBtn, !hasChanges && styles.saveBtnDisabled]} onPress={handleSave} disabled={saving || !hasChanges}>
...
const styles = StyleSheet.create({
  ...
  infoCard: { flexDirection: 'row', backgroundColor: colors.yellowDim, borderRadius: radius.md, padding: spacing.md, marginBottom: spacing.lg, gap: spacing.sm, alignItems: 'flex-start' },
  infoText: { flex: 1, fontSize: 14, color: colors.textDark, lineHeight: 20, fontWeight: '500' },
  rateCard: { backgroundColor: colors.white, borderRadius: radius.lg, padding: spacing.lg, marginBottom: spacing.md, shadowColor: colors.black, shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4, elevation: 3 },
  rateHeader: { flexDirection: 'row', alignItems: 'center', gap: spacing.md, marginBottom: spacing.md },
  rateIcon: { width: 44, height: 44, borderRadius: 22, backgroundColor: colors.yellow, justifyContent: 'center', alignItems: 'center' },
  ...
  currencySymbol: { fontSize: 22, fontWeight: '800', color: colors.yellowDark, marginRight: spacing.xs },
  ...
  previewCard: { backgroundColor: colors.black, borderRadius: radius.lg, padding: spacing.lg, marginBottom: spacing.lg },
  previewTitle: { fontSize: 14, fontWeight: '700', color: colors.yellow, textTransform: 'uppercase', letterSpacing: 1, marginBottom: spacing.md },
  ...
  saveBtn: { flexDirection: 'row', backgroundColor: colors.black, borderRadius: radius.lg, paddingVertical: spacing.lg, alignItems: 'center', justifyContent: 'center', gap: spacing.sm, marginBottom: spacing.md },
